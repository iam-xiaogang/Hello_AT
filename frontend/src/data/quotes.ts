...
export const quotes: Quote[] = [
  ...
  // ---------- 现代励志 ----------
  { text: "每一天都是新的开始。", author: "励志" },
  { text: "所有的努力，都不会被辜负。", author: "励志" },
  { text: "你不必光芒万丈，但请始终温暖有光。", author: "励志" },
  { text: "自律给你自由。", author: "励志" },
  { text: "最好的投资，是投资自己。", author: "励志" },
  { text: "今天比昨天好，就是希望。", author: "励志" },
  { text: "慢慢来，比较快。", author: "励志" },
  { text: "种一棵树最好的时间是十年前，其次是现在。", author: "励志" },
  { text: "生活原本沉闷，但跑起来就有风。", author: "励志" },
  { text: "乾坤未定，你我皆是黑马。", author: "励志" },
  { text: "星光不问赶路人，时光不负有心人。", author: "励志" },
  { text: "但行好事，莫问前程。", author: "励志" },
  { text: "心之所向，素履以往。", author: "励志" },
  { text: "保持热爱，奔赴山海。", author: "励志" },
  { text: "既然选择了远方，便只顾风雨兼程。", author: "汪国真" },
  { text: "所有的坚持，都会发光。", author: "励志" },
  { text: "你只管努力，剩下的交给时间。", author: "励志" },
  { text: "眼里有光，心中有火。", author: "励志" },
  { text: "明天的你，会感谢今天拼命的自己。", author: "励志" },
  { text: "不要因为没有掌声而放弃梦想。", author: "励志" },
  { text: "半山腰太挤，你要去山顶看看。", author: "励志" },
  { text: "优秀是一种习惯。", author: "亚里士多德" },
  { text: "吃过的苦，都会变成照亮前路的光。", author: "励志" },
  { text: "万物皆有裂痕，那是光照进来的地方。", author: "莱昂纳德·科恩" },
  { text: "心若向阳，无谓悲伤。", author: "励志" },
  { text: "生活不止眼前的苟且，还有诗和远方。", author: "高晓松" },
  { text: "愿你走出半生，归来仍是少年。", author: "网络" },
  { text: "把日子过成诗，简单而精致。", author: "励志" },
  { text: "世界很大，你要去看看。", author: "励志" },
];
